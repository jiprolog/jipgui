    ...
    public void keyPressed(KeyEvent e)
    {
        ...
        if(e.getKeyCode() == e.VK_ENTER)
        {
            ...
            if(m_bRecordHistory && !strQuery.equals(""))
            {
                ...
                m_nHistoryIndex = m_historyVect.size() - 1;
...
//                replaceRange(m_historyVect.elementAt(m_nHistoryIndex).toString(), m_nPromptPos, getText().length( - 1);
        ...
        else if(e.getKeyCode() == KeyEvent.VK_UP)
        {
            if(m_historyVect.size() > 0)
            {
                ...
                if((m_nHistoryIndex >= m_historyVect.size()) || (m_nHistoryIndex < 0))
                    m_nHistoryIndex = 0;
